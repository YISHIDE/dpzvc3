import { defineComponent, resolveComponent, createElementBlock, openBlock, normalizeClass, createElementVNode, createVNode, inject, ref, computed, watch } from "vue";
...
const _sfc_main = defineComponent({
  ...
  setup(props2, { emit }) {
    ...
    const currentValue = ref(props2.addressValue || "");
    const province = ref({
      value: "北京市",
      code: "110000",
      target: "province",
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createElementVNode("div", _hoisted_1, [
      ...
      _cache[2] || (_cache[2] = createElementVNode("div", { class: "title" }, "请选择区域", -1)),
      createElementVNode("div", {
        class: "right",
    ...
    createElementVNode("div", _hoisted_2, [
      createVNode(_component_PickerSlot, {
        list: _ctx.provinces,
...
const areaPicker = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  areaPicker as default
};
//# sourceMappingURL=area-picker-CDLLqfWS.mjs.map
