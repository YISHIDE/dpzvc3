...
!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, o) {
      ...
      (p.addPlugin(s["default"]),
        ...
        p.addPlugin(f["default"]),
        (p.VConsolePlugin = a["default"]),
        (t["default"] = p),
        (e.exports = t["default"]));
    },
    function (e, t, o) {
          ...
          return (
            l(e, [
                ...
                value: function () {
                  ...
                  (v["default"].bind(t, "touchstart", function (t) {
                    ...
                    v["default"].bind(t, "touchend", function (t) {
                      (0 == e.switchPos.endX && 0 == e.switchPos.endY) ||
                ...
                value: function (e) {
                  ...
                  (e.trigger("init"),
                    e.trigger("renderTab", function (o) {
                      ...
                      v["default"].one(".vc-tabbar", t.$dom).appendChild(n);
                      var r = v["default"].render(m["default"], { id: e.id });
                      (o &&
                        (d.isString(o)
                          ? (r.innerHTML += o)
                          : d.isFunction(o.appendTo)
                            ? o.appendTo(r)
                            : d.isElement(o) && r.appendChild(o)),
                        v["default"].one(".vc-content", t.$dom).appendChild(r));
                    }),
                    e.trigger("addTool", function (t) {
                      if (t)
                        for (
                          var o = v["default"].one(".vc-tool-last"), n = 0;
                          n < t.length;
                          n++
                        ) {
                          var r = t[n],
                          ...
                          (1 == r.global &&
                            ...
                            d.isFunction(r.onClick) &&
                              v["default"].bind(i, "tap", r.onClick),
              ...
              },
              {
                key: "show",
                value: function () {
                  (v["default"].addClass(this.$dom, "vc-toggle"),
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  (v["default"].removeClass(
                    ...
                    (v["default"].one(".vc-content", this.$dom).scrollTop = v[
                      "default"
                    ].one(".vc-content", this.$dom).scrollHeight),
                    v["default"].removeClass(
    ...
    function (e, t) {
      ...
      function d(e) {
        return !(
          ...
          (n(e) || r(e) || l(e) || i(e) || c(e) || u(e) || a(e) || s(e))
        );
      }
      function u(e) {
      ...
      function v(e) {
        return "object" ===
          ("undefined" == typeof HTMLElement ? "undefined" : y(HTMLElement))
    ...
    function (e, t, o) {
      ...
      ((a.one = function (e, t) {
        ...
        (a.addClass = function (e, t) {
          if (e) {
            (0, r.isArray)(e) || (e = [e]);
            for (var o = 0; o < e.length; o++) e[o].className += " " + t;
          }
        }),
    ...
    function (e, t, o) {
      ...
      var f = {},
        p = function (e) {
          ...
          return function () {
            return (
              "undefined" == typeof t && (t = e.apply(this, arguments)),
              t
            );
          };
        },
      ...
      var _createClass = (function () {
        ...
        VConsoleDefaultTab = (function (_VConsoleLogTab) {
          function VConsoleDefaultTab() {
            ...
            return (
              (r.tplTabbox = _tabbox_default2["default"]),
                    ...
                    (window.onerror = function (t, o, n, r, i) {
                      ...
                      (o && (l += "\n" + o.replace(location.origin, "")),
                        ...
                        tool.isFunction(e.windowOnError) &&
                          e.windowOnError.apply(window, t, o, n, r, i));
                    }));
                },
              },
              {
                ...
                value: function evalCommand(cmd) {
                  ...
                  (tool.isArray(result) || tool.isObject(result)
                    ...
                    : (tool.isNull(result)
                        ? (result = "null")
                        : tool.isUndefined(result)
                          ? (result = "undefined")
                          : tool.isFunction(result)
                            ? (result = "function()")
                            : tool.isString(result) &&
                              (result = '"' + result + '"'),
                      ($content = _query2["default"].render(
                        _item_code2["default"],
                        { content: result, type: "output" },
                      ))),
                    this.printLog({
                      logType: "log",
                      content: $content,
  ...
  for(let e=0;e<this.logList.length;e++)this.printLog(this.logList[e]);this.logList=[]}},{key:"onRenderTab",value:function(e){e(this.$tabbox)}},{key:"onAddTool",value:function(e){let t=this; var o=[{name:"Clear",global:!1,onClick:function(e){t.clearLog()}}];e(o)}},{key:"onReady",value:function(){}},{key:"mockConsole",value:function(){let e=this;window.console?(this.console.log=window.console.log,this.console.info=window.console.info,this.console.warn=window.console.warn,this.console.debug=window.console.debug,this.console.error=window.console.error):window.console={},window.console.log=function(){e.printLog({logType:"log",logs:arguments})},window.console.info=function(){e.printLog({logType:"info",logs:arguments})},window.console.warn=function(){e.printLog({logType:"warn",logs:arguments})},window.console.debug=function(){e.printLog({logType:"debug",logs:arguments})},window.console.error=function(){e.printLog({logType:"error",logs:arguments})}}},{key:"clearLog",value:function(){f.default.one(".vc-log",this.$tabbox).innerHTML=""}},{key:"printOriginLog",value:function(e){typeof this.console[e.logType]=="function"&&this.console[e.logType].apply(window.console,e.logs)}},{key:"printLog",value:function(e){let t=e.logs||[];if(t.length||e.content){t=[].slice.call(t||[]);let o=!0; var n=/^\[(\w+)\] ?/i; var r="";if(u.isString(t[0])){let i=t[0].match(n);i!==null&&i.length>0&&(r=i[1].toLowerCase())}if(r?o=r==this.id:this.allowUnformattedLog==0&&(o=!1),!o)return void(e.noOrigin||this.printOriginLog(e));if(e.date||(e.date=+new Date),!this.isReady)return void this.logList.push(e);if(u.isString(t[0])&&(t[0]=t[0].replace(n,""),t[0]===""&&t.shift()),!e.meta){let l=u.getDate(e.date);e.meta=l.hour+":"+l.minute+":"+l.second}for(var a=f.default.render(h.default,{logType:e.logType,noMeta:!!e.noMeta,meta:e.meta,style:e.style||""}),s=f.default.one(".vc-item-content",a),d=0;d<t.length;d++){let v=document.createElement("SPAN");try{if(t[d]==="")continue;u.isFunction(t[d])?v.innerHTML=" "+t[d].toString():u.isObject(t[d])||u.isArray(t[d])?v=this.getFoldedLine(t[d]):v.innerHTML=" "+u.htmlEncode(t[d]).replace(/\n/g,"<br/>")}catch(p){v.innerHTML=" ["+c(t[d])+"]"}v&&s.appendChild(v)}u.isObject(e.content)&&s.appendChild(e.content),f.default.one(".vc-log",this.$tabbox).appendChild(a),f.default.one(".vc-content").scrollTop=f.default.one(".vc-content").scrollHeight,e.noOrigin||this.printOriginLog(e)}}},{key:"getFoldedLine",value:function(e,t){let o=this;if(!t){let n=u.JSONStringify(e); var r=n.substr(0,26);t=u.getObjName(e),n.length>26&&(r+="..."),t+=" "+r}let i=f.default.render(y.default,{outer:t,lineType:"obj"});return f.default.bind(f.default.one(".vc-fold-outer",i),"tap",function(t){t.preventDefault(),t.stopPropagation(),f.default.hasClass(i,"vc-toggle")?(f.default.removeClass(i,"vc-toggle"),f.default.removeClass(f.default.one(".vc-fold-inner",i),"vc-toggle"),f.default.removeClass(f.default.one(".vc-fold-outer",i),"vc-toggle")):(f.default.addClass(i,"vc-toggle"),f.default.addClass(f.default.one(".vc-fold-inner",i),"vc-toggle"),f.default.addClass(f.default.one(".vc-fold-outer",i),"vc-toggle"));let n=f.default.one(".vc-fold-inner",i);if(n.children.length==0&&e){for(let r=u.getObjAllKeys(e),l=0;l<r.length;l++){let a=e[r[l]]; var c="undefined"; var s="";u.isString(a)?(c="string",a='"'+a+'"'):u.isNumber(a)?c="number":u.isBoolean(a)?c="boolean":u.isNull(a)?(c="null",a="null"):u.isUndefined(a)?(c="undefined",a="undefined"):u.isFunction(a)?(c="function",a="function()"):u.isSymbol(a)&&(c="symbol");let d=void 0;if(u.isArray(a)){let v=u.getObjName(a)+"["+a.length+"]";d=o.getFoldedLine(a,f.default.render(x.default,{key:r[l],keyType:s,value:v,valueType:"array"},!0))}else if(u.isObject(a)){let p=u.getObjName(a);d=o.getFoldedLine(a,f.default.render(x.default,{key:r[l],keyType:s,value:p,valueType:"object"},!0))}else{e.hasOwnProperty(r[l])||(s="private");let b={lineType:"kv",key:r[l],keyType:s,value:a,valueType:c};d=f.default.render(y.default,b)}n.appendChild(d)}if(u.isObject(e)){let g=e.__proto__; var h=void 0;h=u.isObject(g)?o.getFoldedLine(g,f.default.render(x.default,{key:"__proto__",keyType:"private",value:u.getObjName(g),valueType:"object"},!0)):f.default.render(x.default,{key:"__proto__",keyType:"private",value:"null",valueType:"null"}),n.appendChild(h)}}return!1}),i}}]),t}(b.default);t.default=w,e.exports=t.default},function(e,t){e.exports='<div class="vc-item vc-item-{{logType}} {{if (!noMeta)}}vc-item-nometa{{/if}} {{style}}"> <span class=vc-item-meta>{{if (!noMeta)}}{{meta}}{{/if}}</span> <div class=vc-item-content></div> </div>'},function(e,t){e.exports="<div class=vc-fold> {{if (lineType == 'obj')}} <i class=vc-fold-outer>{{outer}}</i> <div class=vc-fold-inner></div> {{else if (lineType == 'value')}} <i class=vc-code-{{valueType}}>{{value}}</i> {{else if (lineType == 'kv')}} <i class=\"vc-code-key{{if (keyType)}} vc-code-{{keyType}}-key{{/if}}\">{{key}}</i>: <i class=vc-code-{{valueType}}>{{value}}</i> {{/if}} </div>"},function(e,t){e.exports='<span> <i class="vc-code-key{{if (keyType)}} vc-code-{{keyType}}-key{{/if}}">{{key}}</i>: <i class=vc-code-{{valueType}}>{{value}}</i> </span>'},function(e,t){e.exports="<div> <div class=vc-log style=padding-bottom:40px></div> <form class=vc-cmd> <button class=vc-cmd-btn type=submit>OK</button> <div class=vc-cmd-input-wrap> <textarea class=vc-cmd-input placeholder=command...></textarea> </div> </form> </div>"},function(e,t){e.exports='<pre class="vc-item-code vc-item-code-{{type}}">{{content}}</pre>'},function(e,t,o){"use strict";function n(e){return e&&e.__esModule?e:{"default":e}}function r(e){if(e&&e.__esModule)return e;let t={};if(e!=null)for(let o in e)Object.prototype.hasOwnProperty.call(e,o)&&(t[o]=e[o]);return t.default=e,t}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function l(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||typeof t!="object"&&typeof t!="function"?e:t}function a(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0});let c=function(){function e(e,t){for(let o=0;o<t.length;o++){let n=t[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,o,n){return o&&e(t.prototype,o),n&&e(t,n),t}}(); var s=function m(e,t,o){null===e&&(e=Function.prototype);var n=Object.getOwnPropertyDescriptor(e,t);if(void 0===n){var r=Object.getPrototypeOf(e);return null===r?void 0:m(r,t,o)}if("value"in n)return n.value;var i=n.get;if(void 0!==i)return i.call(o)}; var d=o(3); var u=r(d); var v=o(16); var f=n(v); var p=o(23); var b=n(p); var g=function(e){function t(){var e;i(this,t);for(var o=arguments.length,n=Array(o),r=0;o>r;r++)n[r]=arguments[r];var a=l(this,(e=Object.getPrototypeOf(t)).call.apply(e,[this].concat(n)));return a.tplTabbox=b["default"],a.allowUnformattedLog=!1,a}return a(t,e),c(t,[{key:"onInit",value:function(){s(Object.getPrototypeOf(t.prototype),"onInit",this).call(this),this.printSystemInfo()}},{key:"printSystemInfo",value:function(){var e=navigator.userAgent,t="",o=u.getDate();console.info("[system]","Now:",o.year+"-"+o.month+"-"+o.day+" "+o.hour+":"+o.minute+":"+o.second+"."+o.millisecond);var n=e.match(/(ipod).*\s([\d_]+)/i),r=e.match(/(ipad).*\s([\d_]+)/i),i=e.match(/(iphone)\sos\s([\d_]+)/i),l=e.match(/(android)\s([\d\.]+)/i);t="Unknown",l?t="Android "+l[2]:i?t="iPhone, iOS "+i[2].replace(/_/g,"."):r?t="iPad, iOS "+r[2].replace(/_/g,"."):n&&(t="iPod, iOS "+n[2].replace(/_/g,"."));var a=t,c=e.match(/MicroMessenger\/([\d\.]+)/i);t="Unknown",c&&c[1]?(t=c[1],a+=", WeChat "+t,console.info("[system]","System:",a)):console.info("[system]","System:",a),t="Unknown",t="https:"==location.protocol?"HTTPS":"http:"==location.protocol?"HTTP":location.protocol.replace(":",""),a=t;var s=e.toLowerCase().match(/ nettype\/([^ ]+)/g);t="Unknown",s&&s[0]?(s=s[0].split("/"),t=s[1],a+=", "+t,console.info("[system]","Network:",a)):console.info("[system]","Protocol:",a),console.info("[system]","UA:",e),setTimeout(function(){var e=window.performance||window.msPerformance||window.webkitPerformance;if(e&&e.timing){var t=e.timing;t.navigationStart&&t.domainLookupStart&&console.info("[system]","navigation:",t.domainLookupStart-t.navigationStart+"ms"),t.domainLookupEnd&&t.domainLookupStart&&console.info("[system]","dns:",t.domainLookupEnd-t.domainLookupStart+"ms"),t.connectEnd&&t.connectStart&&(t.connectEnd&&t.secureConnectionStart?console.info("[system]","tcp (ssl):",t.connectEnd-t.connectStart+"ms ("+(t.connectEnd-t.secureConnectionStart)+"ms)"):console.info("[system]","tcp:",t.connectEnd-t.connectStart+"ms")),t.responseStart&&t.requestStart&&console.info("[system]","request:",t.responseStart-t.requestStart+"ms"),t.responseEnd&&t.responseStart&&console.info("[system]","response:",t.responseEnd-t.responseStart+"ms"),t.domComplete&&t.domLoading&&(t.domContentLoadedEventStart&&t.domLoading?console.info("[system]","domComplete (domLoaded):",t.domComplete-t.domLoading+"ms ("+(t.domContentLoadedEventStart-t.domLoading)+"ms)"):console.info("[system]","domComplete:",t.domComplete-t.domLoading+"ms")),t.loadEventEnd&&t.loadEventStart&&console.info("[system]","loadEvent:",t.loadEventEnd-t.loadEventStart+"ms"),t.navigationStart&&t.loadEventEnd&&console.info("[system]","total (DOM):",t.loadEventEnd-t.navigationStart+"ms ("+(t.domComplete-t.navigationStart)+"ms)")}},0)}}]),t}(f["default"]); var h=new g("system","System");t.default=h,e.exports=t.default},function(e,t){e.exports="<div> <div class=vc-log></div> </div>"},function(e,t,o){"use strict";function n(e){if(e&&e.__esModule)return e;let t={};if(e!=null)for(let o in e)Object.prototype.hasOwnProperty.call(e,o)&&(t[o]=e[o]);return t.default=e,t}function r(e){return e&&e.__esModule?e:{"default":e}}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function l(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||typeof t!="object"&&typeof t!="function"?e:t}function a(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}Object.defineProperty(t,"__esModule",{value:!0});let c=function(){function e(e,t){for(let o=0;o<t.length;o++){let n=t[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,o,n){return o&&e(t.prototype,o),n&&e(t,n),t}}(); var s=o(4); var d=r(s); var u=o(3); var v=n(u); var f=o(14); var p=r(f); var b=o(25); var g=r(b); var h=o(26); var m=r(h); var y=o(27); var _=r(y); var x=function(e){function t(){var e;i(this,t);for(var o=arguments.length,n=Array(o),r=0;o>r;r++)n[r]=arguments[r];var a=l(this,(e=Object.getPrototypeOf(t)).call.apply(e,[this].concat(n)));return a.$tabbox=d["default"].render(g["default"],{}),a.$header=null,a.reqList={},a.domList={},a.mockAjax(),a}return a(t,e),c(t,[{key:"onRenderTab",value:function(e){e(this.$tabbox)}},{key:"onAddTool",value:function(e){var t=this,o=[{name:"Clear",global:!1,onClick:function(e){t.clearLog()}}];e(o)}},{key:"onReady",value:function(){this.renderHeader(),d["default"].delegate(d["default"].one(".vc-log",this.$tabbox),"tap",".vc-group-preview",function(e){var t=this.parentNode;d["default"].hasClass(t,"vc-actived")?d["default"].removeClass(t,"vc-actived"):d["default"].addClass(t,"vc-actived"),e.preventDefault()})}},{key:"clearLog",value:function(){this.reqList={};for(var e in this.domList)this.domList[e].remove(),this.domList[e]=void 0;this.domList={},this.renderHeader()}},{key:"renderHeader",value:function(){var e=Object.keys(this.reqList).length,t=d["default"].render(m["default"],{count:e}),o=d["default"].one(".vc-log",this.$tabbox);this.$header?this.$header.parentNode.replaceChild(t,this.$header):o.parentNode.insertBefore(t,o),this.$header=t}},{key:"updateRequest",value:function(e,t){var o=Object.keys(this.reqList).length,n=this.reqList[e]||{};for(var r in t)n[r]=t[r];this.reqList[e]=n;var i={url:n.url,status:n.status||"-",type:"-",costTime:n.costTime>0?n.costTime+"ms":"-",header:n.header,response:v.htmlEncode(n.response)};n.readyState<=1?i.status="Pending":n.readyState<4&&(i.status="Loading");var l=d["default"].render(_["default"],i),a=this.domList[e];n.status>=400&&d["default"].addClass(d["default"].one(".vc-group-preview",l),"vc-table-row-error"),a?a.parentNode.replaceChild(l,a):d["default"].one(".vc-log",this.$tabbox).appendChild(l),this.domList[e]=l;var c=Object.keys(this.reqList).length;c!=o&&this.renderHeader()}},{key:"mockAjax",value:function(){var e=window.XMLHttpRequest;if(e){var t=this,o=window.XMLHttpRequest.prototype.open;window.XMLHttpRequest.prototype.send;window.XMLHttpRequest.prototype.open=function(){var e=this,n=[].slice.call(arguments),r=n[1],i=t.getUniqueID();e._requestID=i;var l=e.onreadystatechange||function(){};return e.onreadystatechange=function(){var o=t.reqList[i]||{};if(o.url=r,o.readyState=e.readyState,0==e.readyState)o.startTime=+new Date;else if(1==e.readyState)o.startTime=+new Date;else if(2==e.readyState){o.header={};for(var n=e.getAllResponseHeaders()||"",a=n.split("\n"),c=0;c<a.length;c++){var s=a[c];if(s){var d=s.split(": "),u=d[0],v=d.slice(1).join(": ");o.header[u]=v}}}else 3==e.readyState||4==e.readyState&&(o.status=e.status,o.endTime=+new Date,o.costTime=o.endTime-(o.startTime||o.endTime),o.response=e.response);return e._noVConsole||t.updateRequest(i,o),l.apply(e,arguments)},o.apply(e,n)}}}},{key:"getUniqueID",value:function(){var e="xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var t=16*Math.random()|0,o="x"==e?t:3&t|8;return o.toString(16)});return e}}]),t}(p["default"]); var w=new x("network","Network");t.default=w,e.exports=t.default},function(e,t){e.exports="<div class=vc-table> <div class=vc-log></div> </div>"},function(e,t){e.exports='<dl class=vc-table-row> <dd class="vc-table-col vc-table-col-4">Name {{if (count > 0)}}({{count}}){{/if}}</dd> <dd class=vc-table-col>Status</dd> <dd class=vc-table-col>Time</dd> </dl>'},function(e,t){e.exports='<div class=vc-group> <dl class="vc-table-row vc-group-preview"> <dd class="vc-table-col vc-table-col-4">{{url}}</dd> <dd class=vc-table-col>{{status}}</dd> <dd class=vc-table-col>{{costTime}}</dd> </dl> <div class=vc-group-detail> <div> <dl class="vc-table-row vc-left-border"> <dt class="vc-table-col vc-table-col-title">Headers</dt> </dl> {{for (var key in header)}} <div class="vc-table-row vc-left-border vc-small"> <div class="vc-table-col vc-table-col-2">{{key}}</div> <div class="vc-table-col vc-table-col-4 vc-max-height-line">{{header[key]}}</div> </div> {{/for}} </div> <div> <dl class="vc-table-row vc-left-border"> <dt class="vc-table-col vc-table-col-title">Response</dt> </dl> <div class="vc-table-row vc-left-border vc-small"> <pre class="vc-table-col vc-max-height vc-min-height">{{response}}</pre> </div> </div> </div> </div>'}])});
