...
const routers: RouteRecordRaw[] = [
...

  {
    ...
    meta: { title: "guide", skeleton: 'home' },
  },
  {
    path: "/ActionSheet",
    name: "ActionSheet",
    component: loadView("ViewActionSheet"),
    meta: { title: "ViewActionSheet", skeleton: 'home'  },
  },
  {
    path: "/Badge",
    name: "Badge",
    component: loadView("ViewBadge"),
    meta: { title: "ViewBadge", skeleton: 'home'  },
  },
  {
    path: "/Button",
    name: "Button",
    component: loadView("ViewButton"),
    meta: { title: "ViewButton", skeleton: 'home' },
  },
  {
    path: "/Card",
    name: "Card",
    component: loadView("ViewCard"),
    meta: { title: "ViewCard", skeleton: 'home'  },
  },
  {
    path: "/Cell",
    name: "Cell",
    component: loadView("ViewCell"),
    meta: { title: "ViewCell", skeleton: 'home'  },
  },
  {
    path: "/CellSwipe",
    name: "CellSwipe",
    component: loadView("ViewCellSwipe"),
    meta: { title: "ViewCellSwipe", skeleton: 'home'  },
  },
  {
    path: "/CheckBox",
    name: "CheckBox",
    component: loadView("ViewCheckBox"),
    meta: { title: "ViewCheckBox" , skeleton: 'home' },
  },
  {
    path: "/Header",
    name: "Header",
    component: loadView("ViewHeader"),
    meta: { title: "ViewHeader", skeleton: 'home'  },
  },
  {
    path: "/Indicator",
    name: "Indicator",
    component: loadView("ViewIndicator"),
    meta: { title: "ViewIndicator", skeleton: 'home'  },
  },
  {
    path: "/LoadMore",
    name: "LoadMore",
    component: loadView("ViewLoadMore"),
    meta: { title: "ViewLoadMore", skeleton: 'home'  },
  },
  {
    path: "/Message",
    name: "Message",
    component: loadView("ViewMessage"),
    meta: { title: "ViewMessage", skeleton: 'home'  },
  },
  {
    path: "/Modal",
    name: "Modal",
    component: loadView("ViewModal"),
    meta: { title: "ViewModal", skeleton: 'home'  },
  },
  {
    path: "/Picker",
    name: "Picker",
    component: loadView("ViewPicker"),
    meta: { title: "ViewPicker", skeleton: 'home'  },
  },
  {
    path: "/Popup",
    name: "Popup",
    component: loadView("ViewPopup"),
    meta: { title: "ViewPopup", skeleton: 'home'  },
  },
  {
    path: "/Progress",
    name: "Progress",
    component: loadView("ViewProgress"),
    meta: { title: "ViewProgress", skeleton: 'home'  },
  },
  {
    path: "/Prompt",
    name: "Prompt",
    component: loadView("ViewPrompt"),
    meta: { title: "ViewPrompt", skeleton: 'home'  },
  },
  {
    path: "/RadioBox",
    name: "RadioBox",
    component: loadView("ViewRadioBox"),
    meta: { title: "ViewRadioBox", skeleton: 'home'  },
  },
  {
    path: "/Rater",
    name: "Rater",
    component: loadView("ViewRater"),
    meta: { title: "ViewRater", skeleton: 'home'  },
  },
  {
    path: "/SlideBar",
    name: "SlideBar",
    component: loadView("ViewSlideBar"),
    meta: { title: "ViewSlideBar", skeleton: 'home'  },
  },
  {
    path: "/Spinner",
    name: "Spinner",
    component: loadView("ViewSpinner"),
    meta: { title: "ViewSpinner", skeleton: 'home'  },
  },
  {
    path: "/Swipe",
    name: "Swipe",
    component: loadView("ViewSwipe"),
    meta: { title: "ViewSwipe", skeleton: 'home'  },
  },
  {
    path: "/SwitchBar",
    name: "SwitchBar",
    component: loadView("ViewSwitchBar"),
    meta: { title: "ViewSwitchBar", skeleton: 'home'  },
  },
  {
    path: "/Tab",
    name: "Tab",
    component: loadView("ViewTab"),
    meta: { title: "ViewTab", skeleton: 'home'  },
  },
  {
    path: "/Text",
    name: "Text",
    component: loadView("ViewText"),
    meta: { title: "ViewText", skeleton: 'home' },
  },
  {
    path: "/ToTop",
    name: "ToTop",
    component: loadView("ViewToTop"),
    meta: { title: "ViewToTop", skeleton: 'home' },
  },
  {
    path: "/Upload",
    name: "Upload",
    component: loadView("ViewUpload"),
    meta: { title: "ViewUpload", skeleton: 'home'  },
  },
];
